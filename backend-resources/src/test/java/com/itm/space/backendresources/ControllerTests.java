...
public class ControllerTests extends BaseIntegrationTest {
    ...
    @Autowired
    public ControllerTests(RestExceptionHandler restExceptionHandler) {
    ...
    void initNecessaryMocks() {
        testUserRequest =
                new UserRequest("DevOpsITM", "ITM@gmail.com", "1234", "Derll", "Barby");
        testInvalidUserRequest =
                new UserRequest("", "ITM@gmail.com", "1234", "Derll", "Barby");
